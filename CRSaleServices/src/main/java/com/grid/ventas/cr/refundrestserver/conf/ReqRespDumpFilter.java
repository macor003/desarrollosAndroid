...
/**
 * Created by eve0017280 on 29/02/16.
 */
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            final StringBuilder logMessage = new StringBuilder("REST Request - ").append("[HTTP METHOD:")
                    ...
                    .append(httpServletRequest.getRequestURL().toString()).append("] [REQUEST PARAMETERS:")
                    .append(requestMap).append("] [REQUEST BODY:").append(bufferedReqest.getRequestBody())
                    .append("] [REMOTE ADDRESS:").append(httpServletRequest.getRemoteAddr()).append("]");

            chain.doFilter(bufferedReqest, bufferedResponse);
            if ((!requestMap.containsKey("ping")) && bufferedResponse != null
                    && bufferedResponse.getContent() != null) {
                logMessage.append(" [RESPONSE:").append(bufferedResponse.getContent()).append("]");
            }
            if (!requestMap.containsKey("ping")) {
