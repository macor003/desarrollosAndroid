...
import com.grid.ventas.cr.crjpacrsrc.Servicio;
import com.grid.ventas.cr.crjpacrsrc.ServicioPK;
...
public class ServicioJpaController implements Serializable {
    ...
    public void create(Servicio servicio) throws PreexistingEntityException, Exception {
        if (servicio.getServicioPK() == null) {
            servicio.setServicioPK(new ServicioPK());
        }
        ...
        try {
            ...
            if (findServicio(servicio.getServicioPK()) != null) {
    ...
    public void edit(Servicio servicio) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ServicioPK id = servicio.getServicioPK();
    ...
    public void destroy(ServicioPK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public Servicio findServicio(ServicioPK id) {
        EntityManager em = getEntityManager();
        try {
