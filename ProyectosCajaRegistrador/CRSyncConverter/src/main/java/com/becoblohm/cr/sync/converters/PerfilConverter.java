 ...
 */
public class PerfilConverter implements ConverterInterface {
	...
	public Object fromServer(Object obj, String posId) {
		...
		crjpa400.Perfil serverValue = (crjpa400.Perfil) obj;
		crjpa.Perfil posValue = new Perfil();
		...
		dm.setTableName(crjpa.Perfil.class.getName().substring(crjpa.Perfil.class.getName().lastIndexOf(".") + 1));
		return dm;
	}
