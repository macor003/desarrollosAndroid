...
public class GiroactividadeconomicaJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Giroactividadeconomica giroactividadeconomica)
		...
		if (giroactividadeconomica.getTransaccionclienteList() == null) {
			giroactividadeconomica
					.setTransaccionclienteList(new ArrayList<Transaccioncliente>());
		}
		...
		try {
			...
			for (Cliente clienteListClienteToAttach : giroactividadeconomica
					.getClienteList()) {
			...
			for (Transaccioncliente transaccionclienteListTransaccioncliente : giroactividadeconomica
				...
				if (oldIdGiroactividadeconomicaOfTransaccionclienteListTransaccioncliente != null) {
					oldIdGiroactividadeconomicaOfTransaccionclienteListTransaccioncliente
			...
			for (Cliente clienteListCliente : giroactividadeconomica
					.getClienteList()) {
				...
				if (oldIdGiroactividadeconomicaOfClienteListCliente != null) {
					oldIdGiroactividadeconomicaOfClienteListCliente
							.getClienteList().remove(clienteListCliente);
			...
			if (findGiroactividadeconomica(giroactividadeconomica.getId()) != null) {
				throw new PreexistingEntityException("Giroactividadeconomica "
						+ giroactividadeconomica + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Giroactividadeconomica giroactividadeconomica)
		...
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Giroactividadeconomica persistentGiroactividadeconomica = em.find(
					Giroactividadeconomica.class,
			...
			List<Transaccioncliente> transaccionclienteListOld = persistentGiroactividadeconomica
					.getTransaccionclienteList();
			List<Transaccioncliente> transaccionclienteListNew = giroactividadeconomica
					.getTransaccionclienteList();
			List<Cliente> clienteListOld = persistentGiroactividadeconomica
					.getClienteList();
			List<Cliente> clienteListNew = giroactividadeconomica
					.getClienteList();
			...
			giroactividadeconomica
					.setTransaccionclienteList(transaccionclienteListNew);
			...
			for (Transaccioncliente transaccionclienteListOldTransaccioncliente : transaccionclienteListOld) {
				if (!transaccionclienteListNew
					...
					transaccionclienteListOldTransaccioncliente
							.setIdGiroactividadeconomica(null);
					transaccionclienteListOldTransaccioncliente = em
							.merge(transaccionclienteListOldTransaccioncliente);
				}
			}
			...
			for (Cliente clienteListNewCliente : clienteListNew) {
				if (!clienteListOld.contains(clienteListNewCliente)) {
					...
					if (oldIdGiroactividadeconomicaOfClienteListNewCliente != null
							&& !oldIdGiroactividadeconomicaOfClienteListNewCliente
									.equals(giroactividadeconomica)) {
						oldIdGiroactividadeconomicaOfClienteListNewCliente
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findGiroactividadeconomica(id) == null) {
					throw new NonexistentEntityException(
							"The giroactividadeconomica with id " + id
									+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws IllegalOrphanException,
		...
		try {
			...
			try {
				giroactividadeconomica = em.getReference(
						Giroactividadeconomica.class, id);
				giroactividadeconomica.getId();
			...
			for (Categorialineaincluye categorialineaincluyeListOrphanCheckCategorialineaincluye : categorialineaincluyeListOrphanCheck) {
				...
				illegalOrphanMessages
						.add("This Giroactividadeconomica ("
								+ giroactividadeconomica
			...
			List<Transaccioncliente> transaccionclienteList = giroactividadeconomica
					.getTransaccionclienteList();
	...
	public List<Giroactividadeconomica> findGiroactividadeconomicaEntities(
		...
		return findGiroactividadeconomicaEntities(false, maxResults,
				firstResult);
	}
	 ...
	 * @return List<Giroactividadeconomica>
	 */
	private List<Giroactividadeconomica> findGiroactividadeconomicaEntities(
	...
	public int getGiroactividadeconomicaCount() {
		...
		try {
			CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
			Root<Giroactividadeconomica> rt = cq
					.from(Giroactividadeconomica.class);
