...
public class TransaccionformadepagoJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Transaccionformadepago transaccionformadepago)
			throws PreexistingEntityException, Exception {
		if (transaccionformadepago.getFormadepagopuntoagilList() == null) {
			transaccionformadepago
					.setFormadepagopuntoagilList(new ArrayList<Formadepagopuntoagil>());
		}
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Transaccion idTransaccion = transaccionformadepago
					.getIdTransaccion();
			...
			Formadepago idFormadepago = transaccionformadepago
					.getIdFormadepago();
			...
			for (Formadepagopuntoagil formadepagopuntoagilListFormadepagopuntoagilToAttach : transaccionformadepago
				...
				formadepagopuntoagilListFormadepagopuntoagilToAttach = em
						.getReference(
								formadepagopuntoagilListFormadepagopuntoagilToAttach
										.getClass(),
								formadepagopuntoagilListFormadepagopuntoagilToAttach
										.getId());
				attachedFormadepagopuntoagilList
						.add(formadepagopuntoagilListFormadepagopuntoagilToAttach);
			}
			transaccionformadepago
					.setFormadepagopuntoagilList(attachedFormadepagopuntoagilList);
			em.persist(transaccionformadepago);
			if (idTransaccion != null) {
				idTransaccion.getTransaccionformadepagoList().add(
						transaccionformadepago);
				idTransaccion = em.merge(idTransaccion);
			}
			if (idFormadepago != null) {
				idFormadepago.getTransaccionformadepagoList().add(
						transaccionformadepago);
				idFormadepago = em.merge(idFormadepago);
			}
			if (idMoneda != null) {
				idMoneda.getTransaccionformadepagoList().add(
						transaccionformadepago);
			...
			for (Formadepagopuntoagil formadepagopuntoagilListFormadepagopuntoagil : transaccionformadepago
				...
				formadepagopuntoagilListFormadepagopuntoagil
						.setIdTransaccionformadepago(transaccionformadepago);
				formadepagopuntoagilListFormadepagopuntoagil = em
						.merge(formadepagopuntoagilListFormadepagopuntoagil);
				if (oldIdTransaccionformadepagoOfFormadepagopuntoagilListFormadepagopuntoagil != null) {
					oldIdTransaccionformadepagoOfFormadepagopuntoagilListFormadepagopuntoagil
							.getFormadepagopuntoagilList()
							.remove(formadepagopuntoagilListFormadepagopuntoagil);
			...
			if (findTransaccionformadepago(transaccionformadepago.getId()) != null) {
				throw new PreexistingEntityException("Transaccionformadepago "
						+ transaccionformadepago + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Transaccionformadepago transaccionformadepago)
		...
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Transaccionformadepago persistentTransaccionformadepago = em.find(
					Transaccionformadepago.class,
					transaccionformadepago.getId());
			Transaccion idTransaccionOld = persistentTransaccionformadepago
					.getIdTransaccion();
			Transaccion idTransaccionNew = transaccionformadepago
					.getIdTransaccion();
			Formadepago idFormadepagoOld = persistentTransaccionformadepago
					.getIdFormadepago();
			Formadepago idFormadepagoNew = transaccionformadepago
					.getIdFormadepago();
			...
			for (Formadepagopuntoagil formadepagopuntoagilListOldFormadepagopuntoagil : formadepagopuntoagilListOld) {
				if (!formadepagopuntoagilListNew
						.contains(formadepagopuntoagilListOldFormadepagopuntoagil)) {
					if (illegalOrphanMessages == null) {
						illegalOrphanMessages = new ArrayList<String>();
					}
					illegalOrphanMessages
							.add("You must retain Formadepagopuntoagil "
			...
			for (Formadepagopuntoagil formadepagopuntoagilListNewFormadepagopuntoagil : formadepagopuntoagilListNew) {
				if (!formadepagopuntoagilListOld
						.contains(formadepagopuntoagilListNewFormadepagopuntoagil)) {
					Transaccionformadepago oldIdTransaccionformadepagoOfFormadepagopuntoagilListNewFormadepagopuntoagil = formadepagopuntoagilListNewFormadepagopuntoagil
							.getIdTransaccionformadepago();
					formadepagopuntoagilListNewFormadepagopuntoagil
							.setIdTransaccionformadepago(transaccionformadepago);
					...
					if (oldIdTransaccionformadepagoOfFormadepagopuntoagilListNewFormadepagopuntoagil != null
						...
						oldIdTransaccionformadepagoOfFormadepagopuntoagilListNewFormadepagopuntoagil
								.getFormadepagopuntoagilList()
								.remove(formadepagopuntoagilListNewFormadepagopuntoagil);
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findTransaccionformadepago(id) == null) {
					throw new NonexistentEntityException(
							"The transaccionformadepago with id " + id
									+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws IllegalOrphanException,
		...
		try {
			...
			try {
				transaccionformadepago = em.getReference(
						Transaccionformadepago.class, id);
				transaccionformadepago.getId();
			...
			for (Formadepagopuntoagil formadepagopuntoagilListOrphanCheckFormadepagopuntoagil : formadepagopuntoagilListOrphanCheck) {
				...
				illegalOrphanMessages
						.add("This Transaccionformadepago ("
								+ transaccionformadepago
			...
			Transaccion idTransaccion = transaccionformadepago
					.getIdTransaccion();
			if (idTransaccion != null) {
				idTransaccion.getTransaccionformadepagoList().remove(
						transaccionformadepago);
				idTransaccion = em.merge(idTransaccion);
			}
			Formadepago idFormadepago = transaccionformadepago
					.getIdFormadepago();
			if (idFormadepago != null) {
				idFormadepago.getTransaccionformadepagoList().remove(
						transaccionformadepago);
				idFormadepago = em.merge(idFormadepago);
			}
			Moneda idMoneda = transaccionformadepago.getIdMoneda();
			if (idMoneda != null) {
				idMoneda.getTransaccionformadepagoList().remove(
						transaccionformadepago);
				idMoneda = em.merge(idMoneda);
			}
	...
	public List<Transaccionformadepago> findTransaccionformadepagoEntities(
		...
		return findTransaccionformadepagoEntities(false, maxResults,
				firstResult);
	}
	 ...
	 * @return List<Transaccionformadepago>
	 */
	private List<Transaccionformadepago> findTransaccionformadepagoEntities(
	...
	public int getTransaccionformadepagoCount() {
		...
		try {
			CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
			Root<Transaccionformadepago> rt = cq
					.from(Transaccionformadepago.class);
