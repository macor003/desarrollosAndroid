...
public class TipoclienteJpaController implements Serializable {
	...
	public void create(Tipocliente tipocliente)
		...
		if (tipocliente.getTipoidentificacionclienteList() == null) {
			tipocliente
					.setTipoidentificacionclienteList(new ArrayList<Tipoidentificacioncliente>());
		}
		...
		try {
			...
			for (Tipoidentificacioncliente tipoidentificacionclienteListTipoidentificacionclienteToAttach : tipocliente
				...
				tipoidentificacionclienteListTipoidentificacionclienteToAttach = em
						.getReference(
								tipoidentificacionclienteListTipoidentificacionclienteToAttach
										.getClass(),
								tipoidentificacionclienteListTipoidentificacionclienteToAttach
										.getId());
			...
			tipocliente
					.setTipoidentificacionclienteList(attachedTipoidentificacionclienteList);
			List<Cliente> attachedClienteList = new ArrayList<Cliente>();
			for (Cliente clienteListClienteToAttach : tipocliente
					.getClienteList()) {
			...
			for (Tipoidentificacioncliente tipoidentificacionclienteListTipoidentificacioncliente : tipocliente
				...
				if (oldIdTipoclienteOfTipoidentificacionclienteListTipoidentificacioncliente != null) {
					oldIdTipoclienteOfTipoidentificacionclienteListTipoidentificacioncliente
							.getTipoidentificacionclienteList()
							.remove(tipoidentificacionclienteListTipoidentificacioncliente);
			...
			for (Cliente clienteListCliente : tipocliente.getClienteList()) {
				Tipocliente oldIdTipoclienteOfClienteListCliente = clienteListCliente
						.getIdTipocliente();
				clienteListCliente.setIdTipocliente(tipocliente);
				clienteListCliente = em.merge(clienteListCliente);
				if (oldIdTipoclienteOfClienteListCliente != null) {
					oldIdTipoclienteOfClienteListCliente.getClienteList()
							.remove(clienteListCliente);
					oldIdTipoclienteOfClienteListCliente = em
							.merge(oldIdTipoclienteOfClienteListCliente);
				}
			}
			em.getTransaction().commit();
		} catch (Exception ex) {
			if (findTipocliente(tipocliente.getId()) != null) {
				throw new PreexistingEntityException("Tipocliente "
						+ tipocliente + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	...
	public void edit(Tipocliente tipocliente) throws IllegalOrphanException,
		...
		try {
			...
			Tipocliente persistentTipocliente = em.find(Tipocliente.class,
					tipocliente.getId());
			List<Tipoclientetipodocumento> tipoclientetipodocumentoListOld = persistentTipocliente
					.getTipoclientetipodocumentoList();
			List<Tipoclientetipodocumento> tipoclientetipodocumentoListNew = tipocliente
					.getTipoclientetipodocumentoList();
			List<Tipoidentificacioncliente> tipoidentificacionclienteListOld = persistentTipocliente
					.getTipoidentificacionclienteList();
			List<Tipoidentificacioncliente> tipoidentificacionclienteListNew = tipocliente
					.getTipoidentificacionclienteList();
			List<Cliente> clienteListOld = persistentTipocliente
					.getClienteList();
			...
			for (Tipoidentificacioncliente tipoidentificacionclienteListOldTipoidentificacioncliente : tipoidentificacionclienteListOld) {
				if (!tipoidentificacionclienteListNew
						.contains(tipoidentificacionclienteListOldTipoidentificacioncliente)) {
					if (illegalOrphanMessages == null) {
						illegalOrphanMessages = new ArrayList<String>();
					}
					illegalOrphanMessages
							.add("You must retain Tipoidentificacioncliente "
			...
			List<Tipoidentificacioncliente> attachedTipoidentificacionclienteListNew = new ArrayList<Tipoidentificacioncliente>();
			for (Tipoidentificacioncliente tipoidentificacionclienteListNewTipoidentificacionclienteToAttach : tipoidentificacionclienteListNew) {
				tipoidentificacionclienteListNewTipoidentificacionclienteToAttach = em
						.getReference(
				...
				attachedTipoidentificacionclienteListNew
						.add(tipoidentificacionclienteListNewTipoidentificacionclienteToAttach);
			}
			tipoidentificacionclienteListNew = attachedTipoidentificacionclienteListNew;
			tipocliente
					.setTipoidentificacionclienteList(tipoidentificacionclienteListNew);
			...
			for (Tipoclientetipodocumento tipoclientetipodocumentoListNewTipoclientetipodocumento : tipoclientetipodocumentoListNew) {
				if (!tipoclientetipodocumentoListOld
					...
					Tipocliente oldIdTipoclienteOfTipoclientetipodocumentoListNewTipoclientetipodocumento = tipoclientetipodocumentoListNewTipoclientetipodocumento
							.getIdTipocliente();
					...
					if (oldIdTipoclienteOfTipoclientetipodocumentoListNewTipoclientetipodocumento != null
						...
						oldIdTipoclienteOfTipoclientetipodocumentoListNewTipoclientetipodocumento = em
								.merge(oldIdTipoclienteOfTipoclientetipodocumentoListNewTipoclientetipodocumento);
					}
				}
			}
			for (Tipoidentificacioncliente tipoidentificacionclienteListNewTipoidentificacioncliente : tipoidentificacionclienteListNew) {
				if (!tipoidentificacionclienteListOld
						.contains(tipoidentificacionclienteListNewTipoidentificacioncliente)) {
					Tipocliente oldIdTipoclienteOfTipoidentificacionclienteListNewTipoidentificacioncliente = tipoidentificacionclienteListNewTipoidentificacioncliente
							.getIdTipocliente();
					tipoidentificacionclienteListNewTipoidentificacioncliente
							.setIdTipocliente(tipocliente);
					tipoidentificacionclienteListNewTipoidentificacioncliente = em
							.merge(tipoidentificacionclienteListNewTipoidentificacioncliente);
					if (oldIdTipoclienteOfTipoidentificacionclienteListNewTipoidentificacioncliente != null
							&& !oldIdTipoclienteOfTipoidentificacionclienteListNewTipoidentificacioncliente
									.equals(tipocliente)) {
						oldIdTipoclienteOfTipoidentificacionclienteListNewTipoidentificacioncliente
								.getTipoidentificacionclienteList()
								.remove(tipoidentificacionclienteListNewTipoidentificacioncliente);
						oldIdTipoclienteOfTipoidentificacionclienteListNewTipoidentificacioncliente = em
								.merge(oldIdTipoclienteOfTipoidentificacionclienteListNewTipoidentificacioncliente);
					}
				}
			}
			for (Cliente clienteListNewCliente : clienteListNew) {
				if (!clienteListOld.contains(clienteListNewCliente)) {
					Tipocliente oldIdTipoclienteOfClienteListNewCliente = clienteListNewCliente
							.getIdTipocliente();
					...
					if (oldIdTipoclienteOfClienteListNewCliente != null
						...
						oldIdTipoclienteOfClienteListNewCliente = em
								.merge(oldIdTipoclienteOfClienteListNewCliente);
					}
				}
			}
			em.getTransaction().commit();
	...
	public void destroy(Long id) throws IllegalOrphanException,
		...
		try {
			...
			try {
				...
				throw new NonexistentEntityException("The tipocliente with id "
						+ id + " no longer exists.", enfe);
			}
			List<String> illegalOrphanMessages = null;
			List<Tipoclientetipodocumento> tipoclientetipodocumentoListOrphanCheck = tipocliente
					.getTipoclientetipodocumentoList();
			...
			List<Tipoidentificacioncliente> tipoidentificacionclienteListOrphanCheck = tipocliente
					.getTipoidentificacionclienteList();
			for (Tipoidentificacioncliente tipoidentificacionclienteListOrphanCheckTipoidentificacioncliente : tipoidentificacionclienteListOrphanCheck) {
				if (illegalOrphanMessages == null) {
					illegalOrphanMessages = new ArrayList<String>();
				}
				illegalOrphanMessages
	 ...
	 * @return List<Tipocliente>
	 */
	public List<Tipocliente> findTipoclienteEntities(int maxResults,
			int firstResult) {
	 ...
	 * @return List<Tipocliente>
	 */
	private List<Tipocliente> findTipoclienteEntities(boolean all,
