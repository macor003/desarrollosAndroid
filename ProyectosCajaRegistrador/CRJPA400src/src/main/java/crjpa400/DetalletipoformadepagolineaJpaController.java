...
public class DetalletipoformadepagolineaJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Detalletipoformadepagolinea detalletipoformadepagolinea)
			throws PreexistingEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Detalletipoformadepago idDetalletipoformadepago = detalletipoformadepagolinea
					.getIdDetalletipoformadepago();
			if (idDetalletipoformadepago != null) {
				idDetalletipoformadepago = em.getReference(
						idDetalletipoformadepago.getClass(),
						idDetalletipoformadepago.getId());
				detalletipoformadepagolinea
						.setIdDetalletipoformadepago(idDetalletipoformadepago);
			}
			em.persist(detalletipoformadepagolinea);
			if (idDetalletipoformadepago != null) {
				idDetalletipoformadepago.getDetalletipoformadepagolineaList()
						.add(detalletipoformadepagolinea);
				idDetalletipoformadepago = em.merge(idDetalletipoformadepago);
			}
			em.getTransaction().commit();
		} catch (Exception ex) {
			if (findDetalletipoformadepagolinea(detalletipoformadepagolinea
					.getId()) != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Detalletipoformadepagolinea detalletipoformadepagolinea)
			throws NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Detalletipoformadepagolinea persistentDetalletipoformadepagolinea = em
					.find(Detalletipoformadepagolinea.class,
			...
			if (idDetalletipoformadepagoNew != null) {
				idDetalletipoformadepagoNew = em.getReference(
						idDetalletipoformadepagoNew.getClass(),
						idDetalletipoformadepagoNew.getId());
				detalletipoformadepagolinea
						.setIdDetalletipoformadepago(idDetalletipoformadepagoNew);
			}
			detalletipoformadepagolinea = em.merge(detalletipoformadepagolinea);
			if (idDetalletipoformadepagoOld != null
					&& !idDetalletipoformadepagoOld
							.equals(idDetalletipoformadepagoNew)) {
				idDetalletipoformadepagoOld
						.getDetalletipoformadepagolineaList().remove(
								detalletipoformadepagolinea);
				idDetalletipoformadepagoOld = em
						.merge(idDetalletipoformadepagoOld);
			}
			if (idDetalletipoformadepagoNew != null
					&& !idDetalletipoformadepagoNew
							.equals(idDetalletipoformadepagoOld)) {
				idDetalletipoformadepagoNew
						.getDetalletipoformadepagolineaList().add(
								detalletipoformadepagolinea);
				idDetalletipoformadepagoNew = em
						.merge(idDetalletipoformadepagoNew);
			}
			em.getTransaction().commit();
		} catch (Exception ex) {
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findDetalletipoformadepagolinea(id) == null) {
					throw new NonexistentEntityException(
							"The detalletipoformadepagolinea with id " + id
									+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws NonexistentEntityException {
		...
		try {
			...
			try {
				detalletipoformadepagolinea = em.getReference(
						Detalletipoformadepagolinea.class, id);
				detalletipoformadepagolinea.getId();
			...
			if (idDetalletipoformadepago != null) {
				idDetalletipoformadepago.getDetalletipoformadepagolineaList()
						.remove(detalletipoformadepagolinea);
				idDetalletipoformadepago = em.merge(idDetalletipoformadepago);
			}
	...
	public List<Detalletipoformadepagolinea> findDetalletipoformadepagolineaEntities(
		...
		return findDetalletipoformadepagolineaEntities(false, maxResults,
				firstResult);
	}
	 ...
	 * @return List<Detalletipoformadepagolinea>
	 */
	private List<Detalletipoformadepagolinea> findDetalletipoformadepagolineaEntities(
	...
	public int getDetalletipoformadepagolineaCount() {
		...
		try {
			CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
			Root<Detalletipoformadepagolinea> rt = cq
					.from(Detalletipoformadepagolinea.class);
