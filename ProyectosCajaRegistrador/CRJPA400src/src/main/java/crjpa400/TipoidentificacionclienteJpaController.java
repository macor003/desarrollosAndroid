...
public class TipoidentificacionclienteJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Tipoidentificacioncliente tipoidentificacioncliente)
			throws PreexistingEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Tipocliente idTipocliente = tipoidentificacioncliente
					.getIdTipocliente();
			...
			if (idTipocliente != null) {
				idTipocliente.getTipoidentificacionclienteList().add(
						tipoidentificacioncliente);
	 ...
	 * @throws Exception
	 */
	public void edit(Tipoidentificacioncliente tipoidentificacioncliente)
			throws NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Tipoidentificacioncliente persistentTipoidentificacioncliente = em
					.find(Tipoidentificacioncliente.class,
							tipoidentificacioncliente.getId());
			Tipocliente idTipoclienteOld = persistentTipoidentificacioncliente
					.getIdTipocliente();
			Tipocliente idTipoclienteNew = tipoidentificacioncliente
					.getIdTipocliente();
			...
			if (idTipoclienteOld != null
				...
				idTipoclienteOld.getTipoidentificacionclienteList().remove(
						tipoidentificacioncliente);
				idTipoclienteOld = em.merge(idTipoclienteOld);
			}
			if (idTipoclienteNew != null
					&& !idTipoclienteNew.equals(idTipoclienteOld)) {
				idTipoclienteNew.getTipoidentificacionclienteList().add(
						tipoidentificacioncliente);
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findTipoidentificacioncliente(id) == null) {
					throw new NonexistentEntityException(
							"The tipoidentificacioncliente with id " + id
									+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws NonexistentEntityException {
		...
		try {
			...
			try {
				tipoidentificacioncliente = em.getReference(
						Tipoidentificacioncliente.class, id);
				tipoidentificacioncliente.getId();
			...
			Tipocliente idTipocliente = tipoidentificacioncliente
					.getIdTipocliente();
			if (idTipocliente != null) {
				idTipocliente.getTipoidentificacionclienteList().remove(
						tipoidentificacioncliente);
				idTipocliente = em.merge(idTipocliente);
			}
	...
	public List<Tipoidentificacioncliente> findTipoidentificacionclienteEntities(
		...
		return findTipoidentificacionclienteEntities(false, maxResults,
				firstResult);
	}
	 ...
	 * @return List<Tipoidentificacioncliente>
	 */
	private List<Tipoidentificacioncliente> findTipoidentificacionclienteEntities(
	...
	public int getTipoidentificacionclienteCount() {
		...
		try {
			CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
			Root<Tipoidentificacioncliente> rt = cq
					.from(Tipoidentificacioncliente.class);
