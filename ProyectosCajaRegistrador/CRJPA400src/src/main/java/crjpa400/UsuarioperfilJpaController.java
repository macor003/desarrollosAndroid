...
public class UsuarioperfilJpaController implements Serializable {
	...
	public void create(Usuarioperfil usuarioperfil)
		...
		try {
			...
			if (findUsuarioperfil(usuarioperfil.getId()) != null) {
				throw new PreexistingEntityException("Usuarioperfil "
						+ usuarioperfil + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Usuarioperfil usuarioperfil)
			throws NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Usuarioperfil persistentUsuarioperfil = em.find(
					Usuarioperfil.class, usuarioperfil.getId());
	 ...
	 * @return List<Usuarioperfil>
	 */
	public List<Usuarioperfil> findUsuarioperfilEntities(int maxResults,
			int firstResult) {
	 ...
	 * @return List<Usuarioperfil>
	 */
	private List<Usuarioperfil> findUsuarioperfilEntities(boolean all,
