...
public class UsuarioJpaController implements Serializable {
	...
	public void create(Usuario usuario) throws PreexistingEntityException, Exception {
		...
		try {
			...
			for (Sesion sesionListSesionToAttach : usuario.getSesionList()) {
				sesionListSesionToAttach = em.getReference(sesionListSesionToAttach.getClass(),
			...
			for (Transaccion transaccionListTransaccionToAttach : usuario.getTransaccionList()) {
			...
			for (Rolloauditoria rolloauditoriaListRolloauditoriaToAttach : usuario.getRolloauditoriaList()) {
			...
			for (Entrega entregaListEntrega : usuario.getEntregaList()) {
				Usuario oldIdUsuarioautorizanteOfEntregaListEntrega = entregaListEntrega.getIdUsuarioautorizante();
				...
				if (oldIdUsuarioautorizanteOfEntregaListEntrega != null) {
					oldIdUsuarioautorizanteOfEntregaListEntrega.getEntregaList().remove(entregaListEntrega);
					oldIdUsuarioautorizanteOfEntregaListEntrega = em.merge(oldIdUsuarioautorizanteOfEntregaListEntrega);
				}
			}
			for (Sesion sesionListSesion : usuario.getSesionList()) {
				Usuario oldIdUsuarioOfSesionListSesion = sesionListSesion.getIdUsuario();
				sesionListSesion.setIdUsuario(usuario);
				sesionListSesion = em.merge(sesionListSesion);
				if (oldIdUsuarioOfSesionListSesion != null) {
					oldIdUsuarioOfSesionListSesion.getSesionList().remove(sesionListSesion);
					oldIdUsuarioOfSesionListSesion = em.merge(oldIdUsuarioOfSesionListSesion);
				}
			}
			for (Transaccion transaccionListTransaccion : usuario.getTransaccionList()) {
				Usuario oldIdUsuarioOfTransaccionListTransaccion = transaccionListTransaccion.getIdUsuario();
				...
				if (oldIdUsuarioOfTransaccionListTransaccion != null) {
					oldIdUsuarioOfTransaccionListTransaccion.getTransaccionList().remove(transaccionListTransaccion);
					oldIdUsuarioOfTransaccionListTransaccion = em.merge(oldIdUsuarioOfTransaccionListTransaccion);
				}
			}
			for (Usuarioperfil usuarioperfilListUsuarioperfil : usuario.getUsuarioperfilList()) {
				Usuario oldIdUsuarioOfUsuarioperfilListUsuarioperfil = usuarioperfilListUsuarioperfil.getIdUsuario();
				...
				if (oldIdUsuarioOfUsuarioperfilListUsuarioperfil != null) {
					oldIdUsuarioOfUsuarioperfilListUsuarioperfil.getUsuarioperfilList().remove(
			...
			for (Rolloauditoria rolloauditoriaListRolloauditoria : usuario.getRolloauditoriaList()) {
				...
				if (oldIdUsuarioOfRolloauditoriaListRolloauditoria != null) {
					oldIdUsuarioOfRolloauditoriaListRolloauditoria.getRolloauditoriaList().remove(
	...
	public void edit(Usuario usuario) throws IllegalOrphanException, NonexistentEntityException, Exception {
		...
		try {
			...
			List<Transaccion> transaccionListOld = persistentUsuario.getTransaccionList();
			...
			List<Rolloauditoria> rolloauditoriaListOld = persistentUsuario.getRolloauditoriaList();
			List<Rolloauditoria> rolloauditoriaListNew = usuario.getRolloauditoriaList();
			...
			for (Sesion sesionListOldSesion : sesionListOld) {
				if (!sesionListNew.contains(sesionListOldSesion)) {
					...
					illegalOrphanMessages.add("You must retain Sesion " + sesionListOldSesion
			...
			for (Sesion sesionListNewSesionToAttach : sesionListNew) {
				sesionListNewSesionToAttach = em.getReference(sesionListNewSesionToAttach.getClass(),
			...
			for (Entrega entregaListNewEntrega : entregaListNew) {
				if (!entregaListOld.contains(entregaListNewEntrega)) {
					...
					if (oldIdUsuarioautorizanteOfEntregaListNewEntrega != null
							&& !oldIdUsuarioautorizanteOfEntregaListNewEntrega.equals(usuario)) {
						oldIdUsuarioautorizanteOfEntregaListNewEntrega.getEntregaList().remove(entregaListNewEntrega);
			...
			for (Sesion sesionListNewSesion : sesionListNew) {
				if (!sesionListOld.contains(sesionListNewSesion)) {
					Usuario oldIdUsuarioOfSesionListNewSesion = sesionListNewSesion.getIdUsuario();
					sesionListNewSesion.setIdUsuario(usuario);
					sesionListNewSesion = em.merge(sesionListNewSesion);
					if (oldIdUsuarioOfSesionListNewSesion != null && !oldIdUsuarioOfSesionListNewSesion.equals(usuario)) {
						oldIdUsuarioOfSesionListNewSesion.getSesionList().remove(sesionListNewSesion);
						oldIdUsuarioOfSesionListNewSesion = em.merge(oldIdUsuarioOfSesionListNewSesion);
					}
				}
			}
			for (Transaccion transaccionListNewTransaccion : transaccionListNew) {
				if (!transaccionListOld.contains(transaccionListNewTransaccion)) {
					Usuario oldIdUsuarioOfTransaccionListNewTransaccion = transaccionListNewTransaccion.getIdUsuario();
					...
					if (oldIdUsuarioOfTransaccionListNewTransaccion != null
							&& !oldIdUsuarioOfTransaccionListNewTransaccion.equals(usuario)) {
						oldIdUsuarioOfTransaccionListNewTransaccion.getTransaccionList().remove(
			...
			for (Usuarioperfil usuarioperfilListNewUsuarioperfil : usuarioperfilListNew) {
				if (!usuarioperfilListOld.contains(usuarioperfilListNewUsuarioperfil)) {
					...
					if (oldIdUsuarioOfUsuarioperfilListNewUsuarioperfil != null
							&& !oldIdUsuarioOfUsuarioperfilListNewUsuarioperfil.equals(usuario)) {
						oldIdUsuarioOfUsuarioperfilListNewUsuarioperfil.getUsuarioperfilList().remove(
			...
			for (Rolloauditoria rolloauditoriaListNewRolloauditoria : rolloauditoriaListNew) {
				if (!rolloauditoriaListOld.contains(rolloauditoriaListNewRolloauditoria)) {
					...
					if (oldIdUsuarioOfRolloauditoriaListNewRolloauditoria != null
							&& !oldIdUsuarioOfRolloauditoriaListNewRolloauditoria.equals(usuario)) {
						oldIdUsuarioOfRolloauditoriaListNewRolloauditoria.getRolloauditoriaList().remove(
	...
	public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
		...
		try {
			...
			for (Entrega entregaListOrphanCheckEntrega : entregaListOrphanCheck) {
				...
				illegalOrphanMessages.add("This Usuario (" + usuario + ") cannot be destroyed since the Entrega "
			...
			for (Sesion sesionListOrphanCheckSesion : sesionListOrphanCheck) {
				...
				illegalOrphanMessages.add("This Usuario (" + usuario + ") cannot be destroyed since the Sesion "
						+ sesionListOrphanCheckSesion + " in its sesionList field has a non-nullable idUsuario field.");
			}
			List<Transaccion> transaccionListOrphanCheck = usuario.getTransaccionList();
			for (Transaccion transaccionListOrphanCheckTransaccion : transaccionListOrphanCheck) {
				if (illegalOrphanMessages == null) {
					illegalOrphanMessages = new ArrayList<String>();
				}
				illegalOrphanMessages.add("This Usuario (" + usuario + ") cannot be destroyed since the Transaccion "
			...
			for (Usuarioperfil usuarioperfilListOrphanCheckUsuarioperfil : usuarioperfilListOrphanCheck) {
				...
				illegalOrphanMessages.add("This Usuario (" + usuario + ") cannot be destroyed since the Usuarioperfil "
						+ usuarioperfilListOrphanCheckUsuarioperfil
						+ " in its usuarioperfilList field has a non-nullable idUsuario field.");
			}
			List<Rolloauditoria> rolloauditoriaListOrphanCheck = usuario.getRolloauditoriaList();
