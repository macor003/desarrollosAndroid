...
/**
 */
public class IconsResourceBundle extends ListResourceBundle {
	...
	private static final Object[][] contents = {
			...
			{ "up", "up.png" }, { "down", "down.png" }, { "vtaespera", "ventaespera.png" },
			{ "customer", "cliente.png" }, { "payment", "payment.png" }, { "op_payment", "op_payment.png" },
			{ "delivery", "entrega.png" }, { "typedoc", "tipo_doc.png" }, { "refound", "refound.png" },
			...
			{ "ce_e", "ce_domicilio.png" }, { "posip", "eth.png" },
			...
			{ "clientenatural", "natural.png" }, { "clientejuridico", "juridico.png" },
			...
			{ "reprintpay", "reprintpay.png" }, { "exencion", "exencion.png" },
