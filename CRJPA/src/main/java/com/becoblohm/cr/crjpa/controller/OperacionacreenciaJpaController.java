...
public class OperacionacreenciaJpaController extends AbstractJPAController {
     ...
     * @param p_emf
     */
    public OperacionacreenciaJpaController(EntityManagerFactory p_emf) {
    ...
    public Collection<CreditsOperation> getCreditsOperationList() {
        ...
        crjpa.OperacionacreenciaJpaController jpaController = new crjpa.OperacionacreenciaJpaController(emf);
