...
public class DetalletipoformadepagoJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Detalletipoformadepago detalletipoformadepago) throws PreexistingEntityException, Exception {
		if (detalletipoformadepago.getDetalletipoformadepagolineaList() == null) {
			detalletipoformadepago.setDetalletipoformadepagolineaList(new ArrayList<Detalletipoformadepagolinea>());
		}
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Formadepago idFormadepago = detalletipoformadepago.getIdFormadepago();
			...
			for (Detalletipoformadepagolinea detalletipoformadepagolineaListDetalletipoformadepagolineaToAttach : detalletipoformadepago
				...
				detalletipoformadepagolineaListDetalletipoformadepagolineaToAttach = em.getReference(
						detalletipoformadepagolineaListDetalletipoformadepagolineaToAttach.getClass(),
						detalletipoformadepagolineaListDetalletipoformadepagolineaToAttach.getId());
				attachedDetalletipoformadepagolineaList
						.add(detalletipoformadepagolineaListDetalletipoformadepagolineaToAttach);
			}
			detalletipoformadepago.setDetalletipoformadepagolineaList(attachedDetalletipoformadepagolineaList);
			em.persist(detalletipoformadepago);
			if (idFormadepago != null) {
				idFormadepago.getDetalletipoformadepagoList().add(detalletipoformadepago);
			...
			for (Detalletipoformadepagolinea detalletipoformadepagolineaListDetalletipoformadepagolinea : detalletipoformadepago
				...
				if (oldIdDetalletipoformadepagoOfDetalletipoformadepagolineaListDetalletipoformadepagolinea != null) {
					oldIdDetalletipoformadepagoOfDetalletipoformadepagolineaListDetalletipoformadepagolinea
							.getDetalletipoformadepagolineaList().remove(
									detalletipoformadepagolineaListDetalletipoformadepagolinea);
			...
			if (findDetalletipoformadepago(detalletipoformadepago.getId()) != null) {
				throw new PreexistingEntityException("Detalletipoformadepago " + detalletipoformadepago
						+ " already exists.", ex);
			}
			throw ex;
		} finally {
	 ...
	 * @throws Exception
	 */
	public void edit(Detalletipoformadepago detalletipoformadepago) throws IllegalOrphanException,
			NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Detalletipoformadepago persistentDetalletipoformadepago = em.find(Detalletipoformadepago.class,
					detalletipoformadepago.getId());
			Formadepago idFormadepagoOld = persistentDetalletipoformadepago.getIdFormadepago();
			Formadepago idFormadepagoNew = detalletipoformadepago.getIdFormadepago();
			...
			for (Detalletipoformadepagolinea detalletipoformadepagolineaListOldDetalletipoformadepagolinea : detalletipoformadepagolineaListOld) {
				if (!detalletipoformadepagolineaListNew
					...
					illegalOrphanMessages.add("You must retain Detalletipoformadepagolinea "
			...
			for (Detalletipoformadepagolinea detalletipoformadepagolineaListNewDetalletipoformadepagolineaToAttach : detalletipoformadepagolineaListNew) {
				detalletipoformadepagolineaListNewDetalletipoformadepagolineaToAttach = em.getReference(
						detalletipoformadepagolineaListNewDetalletipoformadepagolineaToAttach.getClass(),
						detalletipoformadepagolineaListNewDetalletipoformadepagolineaToAttach.getId());
			...
			detalletipoformadepago.setDetalletipoformadepagolineaList(detalletipoformadepagolineaListNew);
			detalletipoformadepago = em.merge(detalletipoformadepago);
			if (idFormadepagoOld != null && !idFormadepagoOld.equals(idFormadepagoNew)) {
				idFormadepagoOld.getDetalletipoformadepagoList().remove(detalletipoformadepago);
				idFormadepagoOld = em.merge(idFormadepagoOld);
			}
			if (idFormadepagoNew != null && !idFormadepagoNew.equals(idFormadepagoOld)) {
				idFormadepagoNew.getDetalletipoformadepagoList().add(detalletipoformadepago);
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findDetalletipoformadepago(id) == null) {
					throw new NonexistentEntityException("The detalletipoformadepago with id " + id
							+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
		...
		try {
			...
			try {
				detalletipoformadepago = em.getReference(Detalletipoformadepago.class, id);
				detalletipoformadepago.getId();
			} catch (EntityNotFoundException enfe) {
				throw new NonexistentEntityException("The detalletipoformadepago with id " + id + " no longer exists.",
						enfe);
			}
			List<String> illegalOrphanMessages = null;
			...
			Formadepago idFormadepago = detalletipoformadepago.getIdFormadepago();
			if (idFormadepago != null) {
				idFormadepago.getDetalletipoformadepagoList().remove(detalletipoformadepago);
				idFormadepago = em.merge(idFormadepago);
			}
	 ...
	 * @return List<Detalletipoformadepago>
	 */
	public List<Detalletipoformadepago> findDetalletipoformadepagoEntities(int maxResults, int firstResult) {
		return findDetalletipoformadepagoEntities(false, maxResults, firstResult);
	}
	 ...
	 * @return List<Detalletipoformadepago>
	 */
	private List<Detalletipoformadepago> findDetalletipoformadepagoEntities(boolean all, int maxResults, int firstResult) {
	...
	public int getDetalletipoformadepagoCount() {
		...
		try {
			CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
			Root<Detalletipoformadepago> rt = cq.from(Detalletipoformadepago.class);
