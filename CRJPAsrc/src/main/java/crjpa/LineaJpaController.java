...
public class LineaJpaController implements Serializable {
	...
	public void create(Linea linea) throws PreexistingEntityException, Exception {
		...
		try {
			...
			for (Promocionlinea promocionlineaListPromocionlineaToAttach : linea.getPromocionlineaList()) {
			...
			for (Familia familiaListFamiliaToAttach : linea.getFamiliaList()) {
				familiaListFamiliaToAttach = em.getReference(familiaListFamiliaToAttach.getClass(),
			...
			for (Articulo articuloListArticuloToAttach : linea.getArticuloList()) {
			...
			for (Promocionlinea promocionlineaListPromocionlinea : linea.getPromocionlineaList()) {
				Linea oldIdLineaOfPromocionlineaListPromocionlinea = promocionlineaListPromocionlinea.getIdLinea();
				...
				if (oldIdLineaOfPromocionlineaListPromocionlinea != null) {
					oldIdLineaOfPromocionlineaListPromocionlinea.getPromocionlineaList().remove(
			...
			for (Familia familiaListFamilia : linea.getFamiliaList()) {
				Linea oldIdLineaOfFamiliaListFamilia = familiaListFamilia.getIdLinea();
				familiaListFamilia.setIdLinea(linea);
				familiaListFamilia = em.merge(familiaListFamilia);
				if (oldIdLineaOfFamiliaListFamilia != null) {
					oldIdLineaOfFamiliaListFamilia.getFamiliaList().remove(familiaListFamilia);
					oldIdLineaOfFamiliaListFamilia = em.merge(oldIdLineaOfFamiliaListFamilia);
				}
			}
			for (Articulo articuloListArticulo : linea.getArticuloList()) {
				Linea oldIdLineaOfArticuloListArticulo = articuloListArticulo.getIdLinea();
				...
				if (oldIdLineaOfArticuloListArticulo != null) {
					oldIdLineaOfArticuloListArticulo.getArticuloList().remove(articuloListArticulo);
					oldIdLineaOfArticuloListArticulo = em.merge(oldIdLineaOfArticuloListArticulo);
				}
			}
			for (Categorialineaincluye categorialineaincluyeListCategorialineaincluye : linea
				...
				Linea oldIdLineaOfCategorialineaincluyeListCategorialineaincluye = categorialineaincluyeListCategorialineaincluye
						.getIdLinea();
				categorialineaincluyeListCategorialineaincluye.setIdLinea(linea);
				...
				if (oldIdLineaOfCategorialineaincluyeListCategorialineaincluye != null) {
					oldIdLineaOfCategorialineaincluyeListCategorialineaincluye.getCategorialineaincluyeList().remove(
			...
			for (Categorialinearetencion categorialinearetencionListCategorialinearetencion : linea
				...
				Linea oldIdLineaOfCategorialinearetencionListCategorialinearetencion = categorialinearetencionListCategorialinearetencion
						.getIdLinea();
				categorialinearetencionListCategorialinearetencion.setIdLinea(linea);
				...
				if (oldIdLineaOfCategorialinearetencionListCategorialinearetencion != null) {
					oldIdLineaOfCategorialinearetencionListCategorialinearetencion.getCategorialinearetencionList()
	...
	public void edit(Linea linea) throws IllegalOrphanException, NonexistentEntityException, Exception {
		...
		try {
			...
			List<Promocionlinea> promocionlineaListOld = persistentLinea.getPromocionlineaList();
			List<Promocionlinea> promocionlineaListNew = linea.getPromocionlineaList();
			...
			List<Categorialineaincluye> categorialineaincluyeListOld = persistentLinea.getCategorialineaincluyeList();
			List<Categorialineaincluye> categorialineaincluyeListNew = linea.getCategorialineaincluyeList();
			List<Categorialinearetencion> categorialinearetencionListOld = persistentLinea
					.getCategorialinearetencionList();
			List<Categorialinearetencion> categorialinearetencionListNew = linea.getCategorialinearetencionList();
			...
			for (Familia familiaListOldFamilia : familiaListOld) {
				if (!familiaListNew.contains(familiaListOldFamilia)) {
					...
					illegalOrphanMessages.add("You must retain Familia " + familiaListOldFamilia
							+ " since its idLinea field is not nullable.");
				}
			}
			...
			for (Familia familiaListNewFamiliaToAttach : familiaListNew) {
				familiaListNewFamiliaToAttach = em.getReference(familiaListNewFamiliaToAttach.getClass(),
			...
			for (Promocionlinea promocionlineaListNewPromocionlinea : promocionlineaListNew) {
				if (!promocionlineaListOld.contains(promocionlineaListNewPromocionlinea)) {
					...
					if (oldIdLineaOfPromocionlineaListNewPromocionlinea != null
							&& !oldIdLineaOfPromocionlineaListNewPromocionlinea.equals(linea)) {
						oldIdLineaOfPromocionlineaListNewPromocionlinea.getPromocionlineaList().remove(
			...
			for (Familia familiaListNewFamilia : familiaListNew) {
				if (!familiaListOld.contains(familiaListNewFamilia)) {
					Linea oldIdLineaOfFamiliaListNewFamilia = familiaListNewFamilia.getIdLinea();
					familiaListNewFamilia.setIdLinea(linea);
					familiaListNewFamilia = em.merge(familiaListNewFamilia);
					if (oldIdLineaOfFamiliaListNewFamilia != null && !oldIdLineaOfFamiliaListNewFamilia.equals(linea)) {
						oldIdLineaOfFamiliaListNewFamilia.getFamiliaList().remove(familiaListNewFamilia);
						oldIdLineaOfFamiliaListNewFamilia = em.merge(oldIdLineaOfFamiliaListNewFamilia);
					}
				}
			}
			for (Articulo articuloListNewArticulo : articuloListNew) {
				if (!articuloListOld.contains(articuloListNewArticulo)) {
					Linea oldIdLineaOfArticuloListNewArticulo = articuloListNewArticulo.getIdLinea();
					...
					if (oldIdLineaOfArticuloListNewArticulo != null
							&& !oldIdLineaOfArticuloListNewArticulo.equals(linea)) {
						oldIdLineaOfArticuloListNewArticulo.getArticuloList().remove(articuloListNewArticulo);
						oldIdLineaOfArticuloListNewArticulo = em.merge(oldIdLineaOfArticuloListNewArticulo);
					}
				}
			}
			for (Categorialineaincluye categorialineaincluyeListNewCategorialineaincluye : categorialineaincluyeListNew) {
				if (!categorialineaincluyeListOld.contains(categorialineaincluyeListNewCategorialineaincluye)) {
					Linea oldIdLineaOfCategorialineaincluyeListNewCategorialineaincluye = categorialineaincluyeListNewCategorialineaincluye
							.getIdLinea();
					categorialineaincluyeListNewCategorialineaincluye.setIdLinea(linea);
					...
					if (oldIdLineaOfCategorialineaincluyeListNewCategorialineaincluye != null
							&& !oldIdLineaOfCategorialineaincluyeListNewCategorialineaincluye.equals(linea)) {
						oldIdLineaOfCategorialineaincluyeListNewCategorialineaincluye.getCategorialineaincluyeList()
			...
			for (Categorialinearetencion categorialinearetencionListNewCategorialinearetencion : categorialinearetencionListNew) {
				if (!categorialinearetencionListOld.contains(categorialinearetencionListNewCategorialinearetencion)) {
					Linea oldIdLineaOfCategorialinearetencionListNewCategorialinearetencion = categorialinearetencionListNewCategorialinearetencion
							.getIdLinea();
					categorialinearetencionListNewCategorialinearetencion.setIdLinea(linea);
					...
					if (oldIdLineaOfCategorialinearetencionListNewCategorialinearetencion != null
							&& !oldIdLineaOfCategorialinearetencionListNewCategorialinearetencion.equals(linea)) {
	...
	public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
		...
		try {
			...
			List<String> illegalOrphanMessages = null;
			List<Promocionlinea> promocionlineaListOrphanCheck = linea.getPromocionlineaList();
			for (Promocionlinea promocionlineaListOrphanCheckPromocionlinea : promocionlineaListOrphanCheck) {
				if (illegalOrphanMessages == null) {
					illegalOrphanMessages = new ArrayList<String>();
				}
				illegalOrphanMessages.add("This Linea (" + linea + ") cannot be destroyed since the Promocionlinea "
			...
			for (Familia familiaListOrphanCheckFamilia : familiaListOrphanCheck) {
				...
				illegalOrphanMessages
						.add("This Linea (" + linea + ") cannot be destroyed since the Familia "
			...
			for (Articulo articuloListOrphanCheckArticulo : articuloListOrphanCheck) {
				...
				illegalOrphanMessages.add("This Linea (" + linea + ") cannot be destroyed since the Articulo "
						+ articuloListOrphanCheckArticulo
						+ " in its articuloList field has a non-nullable idLinea field.");
			}
			List<Categorialineaincluye> categorialineaincluyeListOrphanCheck = linea.getCategorialineaincluyeList();
			for (Categorialineaincluye categorialineaincluyeListOrphanCheckCategorialineaincluye : categorialineaincluyeListOrphanCheck) {
				if (illegalOrphanMessages == null) {
					illegalOrphanMessages = new ArrayList<String>();
				}
				illegalOrphanMessages.add("This Linea (" + linea
