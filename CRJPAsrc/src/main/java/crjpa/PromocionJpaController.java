...
public class PromocionJpaController implements Serializable {
	...
	public void create(Promocion promocion) throws PreexistingEntityException, Exception {
		if (promocion.getPromocionformadepagoList() == null) {
			promocion.setPromocionformadepagoList(new ArrayList<Promocionformadepago>());
		}
		...
		if (promocion.getPromociontipodescuentoList() == null) {
			promocion.setPromociontipodescuentoList(new ArrayList<Promociontipodescuento>());
		}
		if (promocion.getPromocionarticuloList() == null) {
			promocion.setPromocionarticuloList(new ArrayList<Promocionarticulo>());
		}
		if (promocion.getPromocioncategoriaList() == null) {
			promocion.setPromocioncategoriaList(new ArrayList<Promocioncategoria>());
		}
		if (promocion.getTransaccionarticuloList() == null) {
			promocion.setTransaccionarticuloList(new ArrayList<Transaccionarticulo>());
		}
		if (promocion.getPromocionfamiliaList() == null) {
			promocion.setPromocionfamiliaList(new ArrayList<Promocionfamilia>());
		}
		...
		try {
			...
			promocion.setPromocionformadepagoList(attachedPromocionformadepagoList);
			List<Promocionlinea> attachedPromocionlineaList = new ArrayList<Promocionlinea>();
			for (Promocionlinea promocionlineaListPromocionlineaToAttach : promocion.getPromocionlineaList()) {
				...
				attachedPromocionlineaList.add(promocionlineaListPromocionlineaToAttach);
			}
			...
			promocion.setPromociontipodescuentoList(attachedPromociontipodescuentoList);
			...
			promocion.setTransaccionarticuloList(attachedTransaccionarticuloList);
			List<Promocionfamilia> attachedPromocionfamiliaList = new ArrayList<Promocionfamilia>();
			for (Promocionfamilia promocionfamiliaListPromocionfamiliaToAttach : promocion.getPromocionfamiliaList()) {
			...
			for (Promocionformadepago promocionformadepagoListPromocionformadepago : promocion
				...
				Promocion oldIdPromocionOfPromocionformadepagoListPromocionformadepago = promocionformadepagoListPromocionformadepago
						.getIdPromocion();
				promocionformadepagoListPromocionformadepago.setIdPromocion(promocion);
				...
				if (oldIdPromocionOfPromocionformadepagoListPromocionformadepago != null) {
					oldIdPromocionOfPromocionformadepagoListPromocionformadepago.getPromocionformadepagoList().remove(
			...
			for (Promocionlinea promocionlineaListPromocionlinea : promocion.getPromocionlineaList()) {
				...
				promocionlineaListPromocionlinea = em.merge(promocionlineaListPromocionlinea);
				if (oldIdPromocionOfPromocionlineaListPromocionlinea != null) {
					oldIdPromocionOfPromocionlineaListPromocionlinea.getPromocionlineaList().remove(
			...
			for (Promociontipodescuento promociontipodescuentoListPromociontipodescuento : promocion
				...
				Promocion oldIdPromocionOfPromociontipodescuentoListPromociontipodescuento = promociontipodescuentoListPromociontipodescuento
						.getIdPromocion();
				promociontipodescuentoListPromociontipodescuento.setIdPromocion(promocion);
				...
				if (oldIdPromocionOfPromociontipodescuentoListPromociontipodescuento != null) {
					oldIdPromocionOfPromociontipodescuentoListPromociontipodescuento.getPromociontipodescuentoList()
			...
			for (Promocionarticulo promocionarticuloListPromocionarticulo : promocion.getPromocionarticuloList()) {
				Promocion oldIdPromocionOfPromocionarticuloListPromocionarticulo = promocionarticuloListPromocionarticulo
						.getIdPromocion();
				promocionarticuloListPromocionarticulo.setIdPromocion(promocion);
				...
				if (oldIdPromocionOfPromocionarticuloListPromocionarticulo != null) {
					oldIdPromocionOfPromocionarticuloListPromocionarticulo.getPromocionarticuloList().remove(
			...
			for (Promocioncategoria promocioncategoriaListPromocioncategoria : promocion.getPromocioncategoriaList()) {
				Promocion oldIdPromocionOfPromocioncategoriaListPromocioncategoria = promocioncategoriaListPromocioncategoria
						.getIdPromocion();
				promocioncategoriaListPromocioncategoria.setIdPromocion(promocion);
				...
				if (oldIdPromocionOfPromocioncategoriaListPromocioncategoria != null) {
					oldIdPromocionOfPromocioncategoriaListPromocioncategoria.getPromocioncategoriaList().remove(
			...
			for (Transaccionarticulo transaccionarticuloListTransaccionarticulo : promocion
				...
				Promocion oldIdPromocionOfTransaccionarticuloListTransaccionarticulo = transaccionarticuloListTransaccionarticulo
						.getIdPromocion();
				transaccionarticuloListTransaccionarticulo.setIdPromocion(promocion);
				...
				if (oldIdPromocionOfTransaccionarticuloListTransaccionarticulo != null) {
					oldIdPromocionOfTransaccionarticuloListTransaccionarticulo.getTransaccionarticuloList().remove(
			...
			for (Promocionfamilia promocionfamiliaListPromocionfamilia : promocion.getPromocionfamiliaList()) {
				...
				if (oldIdPromocionOfPromocionfamiliaListPromocionfamilia != null) {
					oldIdPromocionOfPromocionfamiliaListPromocionfamilia.getPromocionfamiliaList().remove(
	...
	public void edit(Promocion promocion) throws IllegalOrphanException, NonexistentEntityException, Exception {
		...
		try {
			...
			List<Promocionformadepago> promocionformadepagoListOld = persistentPromocion.getPromocionformadepagoList();
			List<Promocionformadepago> promocionformadepagoListNew = promocion.getPromocionformadepagoList();
			List<Promocionlinea> promocionlineaListOld = persistentPromocion.getPromocionlineaList();
			List<Promocionlinea> promocionlineaListNew = promocion.getPromocionlineaList();
			List<Promociontipodescuento> promociontipodescuentoListOld = persistentPromocion
					.getPromociontipodescuentoList();
			List<Promociontipodescuento> promociontipodescuentoListNew = promocion.getPromociontipodescuentoList();
			List<Promocionarticulo> promocionarticuloListOld = persistentPromocion.getPromocionarticuloList();
			List<Promocionarticulo> promocionarticuloListNew = promocion.getPromocionarticuloList();
			List<Promocioncategoria> promocioncategoriaListOld = persistentPromocion.getPromocioncategoriaList();
			List<Promocioncategoria> promocioncategoriaListNew = promocion.getPromocioncategoriaList();
			List<Transaccionarticulo> transaccionarticuloListOld = persistentPromocion.getTransaccionarticuloList();
			List<Transaccionarticulo> transaccionarticuloListNew = promocion.getTransaccionarticuloList();
			List<Promocionfamilia> promocionfamiliaListOld = persistentPromocion.getPromocionfamiliaList();
			List<Promocionfamilia> promocionfamiliaListNew = promocion.getPromocionfamiliaList();
			...
			for (Promocionlinea promocionlineaListOldPromocionlinea : promocionlineaListOld) {
				if (!promocionlineaListNew.contains(promocionlineaListOldPromocionlinea)) {
					if (illegalOrphanMessages == null) {
						illegalOrphanMessages = new ArrayList<String>();
					}
					illegalOrphanMessages.add("You must retain Promocionlinea " + promocionlineaListOldPromocionlinea
							+ " since its idPromocion field is not nullable.");
				}
			}
			...
			for (Promocionfamilia promocionfamiliaListOldPromocionfamilia : promocionfamiliaListOld) {
				if (!promocionfamiliaListNew.contains(promocionfamiliaListOldPromocionfamilia)) {
					...
					illegalOrphanMessages
							.add("You must retain Promocionfamilia " + promocionfamiliaListOldPromocionfamilia
									+ " since its idPromocion field is not nullable.");
				}
			}
			if (illegalOrphanMessages != null) {
			...
			for (Promocionlinea promocionlineaListNewPromocionlineaToAttach : promocionlineaListNew) {
				...
				attachedPromocionlineaListNew.add(promocionlineaListNewPromocionlineaToAttach);
			}
			...
			promocion.setPromociontipodescuentoList(promociontipodescuentoListNew);
			...
			for (Promocionformadepago promocionformadepagoListNewPromocionformadepago : promocionformadepagoListNew) {
				if (!promocionformadepagoListOld.contains(promocionformadepagoListNewPromocionformadepago)) {
					Promocion oldIdPromocionOfPromocionformadepagoListNewPromocionformadepago = promocionformadepagoListNewPromocionformadepago
							.getIdPromocion();
					promocionformadepagoListNewPromocionformadepago.setIdPromocion(promocion);
					...
					if (oldIdPromocionOfPromocionformadepagoListNewPromocionformadepago != null
							&& !oldIdPromocionOfPromocionformadepagoListNewPromocionformadepago.equals(promocion)) {
						oldIdPromocionOfPromocionformadepagoListNewPromocionformadepago.getPromocionformadepagoList()
			...
			for (Promocionlinea promocionlineaListNewPromocionlinea : promocionlineaListNew) {
				if (!promocionlineaListOld.contains(promocionlineaListNewPromocionlinea)) {
					Promocion oldIdPromocionOfPromocionlineaListNewPromocionlinea = promocionlineaListNewPromocionlinea
							.getIdPromocion();
					promocionlineaListNewPromocionlinea.setIdPromocion(promocion);
					promocionlineaListNewPromocionlinea = em.merge(promocionlineaListNewPromocionlinea);
					if (oldIdPromocionOfPromocionlineaListNewPromocionlinea != null
							&& !oldIdPromocionOfPromocionlineaListNewPromocionlinea.equals(promocion)) {
						oldIdPromocionOfPromocionlineaListNewPromocionlinea.getPromocionlineaList().remove(
			...
			for (Promociontipodescuento promociontipodescuentoListNewPromociontipodescuento : promociontipodescuentoListNew) {
				if (!promociontipodescuentoListOld.contains(promociontipodescuentoListNewPromociontipodescuento)) {
					Promocion oldIdPromocionOfPromociontipodescuentoListNewPromociontipodescuento = promociontipodescuentoListNewPromociontipodescuento
							.getIdPromocion();
					promociontipodescuentoListNewPromociontipodescuento.setIdPromocion(promocion);
					...
					if (oldIdPromocionOfPromociontipodescuentoListNewPromociontipodescuento != null
							&& !oldIdPromocionOfPromociontipodescuentoListNewPromociontipodescuento.equals(promocion)) {
			...
			for (Promocionarticulo promocionarticuloListNewPromocionarticulo : promocionarticuloListNew) {
				if (!promocionarticuloListOld.contains(promocionarticuloListNewPromocionarticulo)) {
					Promocion oldIdPromocionOfPromocionarticuloListNewPromocionarticulo = promocionarticuloListNewPromocionarticulo
							.getIdPromocion();
					promocionarticuloListNewPromocionarticulo.setIdPromocion(promocion);
					...
					if (oldIdPromocionOfPromocionarticuloListNewPromocionarticulo != null
							&& !oldIdPromocionOfPromocionarticuloListNewPromocionarticulo.equals(promocion)) {
						oldIdPromocionOfPromocionarticuloListNewPromocionarticulo.getPromocionarticuloList().remove(
			...
			for (Promocioncategoria promocioncategoriaListNewPromocioncategoria : promocioncategoriaListNew) {
				if (!promocioncategoriaListOld.contains(promocioncategoriaListNewPromocioncategoria)) {
					Promocion oldIdPromocionOfPromocioncategoriaListNewPromocioncategoria = promocioncategoriaListNewPromocioncategoria
							.getIdPromocion();
					promocioncategoriaListNewPromocioncategoria.setIdPromocion(promocion);
					...
					if (oldIdPromocionOfPromocioncategoriaListNewPromocioncategoria != null
							&& !oldIdPromocionOfPromocioncategoriaListNewPromocioncategoria.equals(promocion)) {
						oldIdPromocionOfPromocioncategoriaListNewPromocioncategoria.getPromocioncategoriaList().remove(
			...
			for (Transaccionarticulo transaccionarticuloListOldTransaccionarticulo : transaccionarticuloListOld) {
				if (!transaccionarticuloListNew.contains(transaccionarticuloListOldTransaccionarticulo)) {
					transaccionarticuloListOldTransaccionarticulo.setIdPromocion(null);
			...
			for (Transaccionarticulo transaccionarticuloListNewTransaccionarticulo : transaccionarticuloListNew) {
				if (!transaccionarticuloListOld.contains(transaccionarticuloListNewTransaccionarticulo)) {
					Promocion oldIdPromocionOfTransaccionarticuloListNewTransaccionarticulo = transaccionarticuloListNewTransaccionarticulo
							.getIdPromocion();
					transaccionarticuloListNewTransaccionarticulo.setIdPromocion(promocion);
					...
					if (oldIdPromocionOfTransaccionarticuloListNewTransaccionarticulo != null
							&& !oldIdPromocionOfTransaccionarticuloListNewTransaccionarticulo.equals(promocion)) {
						oldIdPromocionOfTransaccionarticuloListNewTransaccionarticulo.getTransaccionarticuloList()
			...
			for (Promocionfamilia promocionfamiliaListNewPromocionfamilia : promocionfamiliaListNew) {
				if (!promocionfamiliaListOld.contains(promocionfamiliaListNewPromocionfamilia)) {
					Promocion oldIdPromocionOfPromocionfamiliaListNewPromocionfamilia = promocionfamiliaListNewPromocionfamilia
							.getIdPromocion();
					promocionfamiliaListNewPromocionfamilia.setIdPromocion(promocion);
					...
					if (oldIdPromocionOfPromocionfamiliaListNewPromocionfamilia != null
							&& !oldIdPromocionOfPromocionfamiliaListNewPromocionfamilia.equals(promocion)) {
						oldIdPromocionOfPromocionfamiliaListNewPromocionfamilia.getPromocionfamiliaList().remove(
	...
	public void destroy(Long id) throws IllegalOrphanException, NonexistentEntityException {
		...
		try {
			...
			List<String> illegalOrphanMessages = null;
			List<Promocionformadepago> promocionformadepagoListOrphanCheck = promocion.getPromocionformadepagoList();
			for (Promocionformadepago promocionformadepagoListOrphanCheckPromocionformadepago : promocionformadepagoListOrphanCheck) {
				if (illegalOrphanMessages == null) {
					illegalOrphanMessages = new ArrayList<String>();
				}
				illegalOrphanMessages.add("This Promocion (" + promocion
			...
			List<Promocionlinea> promocionlineaListOrphanCheck = promocion.getPromocionlineaList();
			...
			List<Promocionarticulo> promocionarticuloListOrphanCheck = promocion.getPromocionarticuloList();
			...
			List<Promocioncategoria> promocioncategoriaListOrphanCheck = promocion.getPromocioncategoriaList();
			...
			List<Promocionfamilia> promocionfamiliaListOrphanCheck = promocion.getPromocionfamiliaList();
			...
			List<Transaccionarticulo> transaccionarticuloList = promocion.getTransaccionarticuloList();
