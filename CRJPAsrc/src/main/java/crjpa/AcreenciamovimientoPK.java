...
public class AcreenciamovimientoPK implements Serializable {
	 ...
	 *            long
	 */
	public AcreenciamovimientoPK(long idAcreenciamovimientosaldo, long idAcreenciamovimientoformadepago) {
	...
	public String toString() {
		return "crjpa400.AcreenciamovimientoPK[ idAcreenciamovimientosaldo=" + idAcreenciamovimientosaldo
				+ ", idAcreenciamovimientoformadepago=" + idAcreenciamovimientoformadepago + " ]";
	}
