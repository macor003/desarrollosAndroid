...
public class TransaccionJpaController implements Serializable {
	...
	public void create(Transaccion transaccion)
		...
		if (transaccion.getTransaccionformadepagoList() == null) {
			transaccion.setTransaccionformadepagoList(
					new ArrayList<Transaccionformadepago>());
		}
		...
		if (transaccion.getTransaccionarticuloList() == null) {
			transaccion.setTransaccionarticuloList(
					new ArrayList<Transaccionarticulo>());
		}
		if (transaccion.getTransaccionfaseList() == null) {
			transaccion
					.setTransaccionfaseList(new ArrayList<Transaccionfase>());
		}
		if (transaccion.getTransacciondocumentoList() == null) {
			transaccion.setTransacciondocumentoList(
					new ArrayList<Transacciondocumento>());
		}
		if (transaccion.getTransaccionclienteList() == null) {
			transaccion.setTransaccionclienteList(
					new ArrayList<Transaccioncliente>());
		}
		...
		try {
			...
			Cliente numeroIdentificacionCliente = transaccion
			...
			if (numeroIdentificacionCliente != null) {
				numeroIdentificacionCliente = em.getReference(
						...
						numeroIdentificacionCliente
								.getNumeroIdentificacionCliente());
				transaccion.setNumeroIdentificacionCliente(
						numeroIdentificacionCliente);
			}
			...
			if (idRolloauditoria != null) {
				idRolloauditoria = em.getReference(idRolloauditoria.getClass(),
						idRolloauditoria.getId());
				transaccion.setIdRolloauditoria(idRolloauditoria);
			}
			Serialimpresora idSerialimpresora = transaccion
					.getIdSerialimpresora();
			if (idSerialimpresora != null) {
				idSerialimpresora = em.getReference(
						idSerialimpresora.getClass(),
			...
			Transaccion idAnulaciontransaccion = transaccion
					.getIdAnulaciontransaccion();
			if (idAnulaciontransaccion != null) {
				idAnulaciontransaccion = em.getReference(
						idAnulaciontransaccion.getClass(),
			...
			for (Transaccionformadepago transaccionformadepagoListTransaccionformadepagoToAttach : transaccion
				...
				transaccionformadepagoListTransaccionformadepagoToAttach = em
						.getReference(
								...
								transaccionformadepagoListTransaccionformadepagoToAttach
										.getId());
				attachedTransaccionformadepagoList.add(
						transaccionformadepagoListTransaccionformadepagoToAttach);
			}
			transaccion.setTransaccionformadepagoList(
					attachedTransaccionformadepagoList);
			List<Transaccion> attachedTransaccionList = new ArrayList<Transaccion>();
			for (Transaccion transaccionListTransaccionToAttach : transaccion
					.getTransaccionList()) {
			...
			for (Transaccionarticulo transaccionarticuloListTransaccionarticuloToAttach : transaccion
				...
				transaccionarticuloListTransaccionarticuloToAttach = em
						.getReference(
								...
								transaccionarticuloListTransaccionarticuloToAttach
										.getId());
				attachedTransaccionarticuloList.add(
						transaccionarticuloListTransaccionarticuloToAttach);
			}
			transaccion.setTransaccionarticuloList(
					attachedTransaccionarticuloList);
			List<Transaccionfase> attachedTransaccionfaseList = new ArrayList<Transaccionfase>();
			for (Transaccionfase transaccionfaseListTransaccionfaseToAttach : transaccion
					.getTransaccionfaseList()) {
				...
				attachedTransaccionfaseList
						.add(transaccionfaseListTransaccionfaseToAttach);
			}
			...
			for (Transacciondocumento transacciondocumentoListTransacciondocumentoToAttach : transaccion
				...
				transacciondocumentoListTransacciondocumentoToAttach = em
						.getReference(
								...
								transacciondocumentoListTransacciondocumentoToAttach
										.getId());
				attachedTransacciondocumentoList.add(
						transacciondocumentoListTransacciondocumentoToAttach);
			}
			transaccion.setTransacciondocumentoList(
			...
			transaccion
					.setTransaccionclienteList(attachedTransaccionclienteList);
			List<Devolucion> attachedDevolucionList = new ArrayList<Devolucion>();
			// for (Devolucion devolucionListDevolucionToAttach : transaccion
			// .getDevolucionList()) {
			// devolucionListDevolucionToAttach = em.getReference(
			// devolucionListDevolucionToAttach.getClass(),
			...
			for (Pagocredito pagocreditoListPagocreditoToAttach : transaccion
					.getPagocreditoList()) {
			...
			if (numeroIdentificacionCliente != null) {
				numeroIdentificacionCliente.getTransaccionList()
						.add(transaccion);
			...
			for (Transaccionformadepago transaccionformadepagoListTransaccionformadepago : transaccion
				...
				transaccionformadepagoListTransaccionformadepago
						.setIdTransaccion(transaccion);
				transaccionformadepagoListTransaccionformadepago = em.merge(
						transaccionformadepagoListTransaccionformadepago);
				if (oldIdTransaccionOfTransaccionformadepagoListTransaccionformadepago != null) {
					oldIdTransaccionOfTransaccionformadepagoListTransaccionformadepago
							.getTransaccionformadepagoList()
			...
			for (Transaccion transaccionListTransaccion : transaccion
				...
				if (oldIdAnulaciontransaccionOfTransaccionListTransaccion != null) {
					oldIdAnulaciontransaccionOfTransaccionListTransaccion
							.getTransaccionList()
			...
			for (Transaccionarticulo transaccionarticuloListTransaccionarticulo : transaccion
				...
				if (oldIdTransaccionOfTransaccionarticuloListTransaccionarticulo != null) {
					oldIdTransaccionOfTransaccionarticuloListTransaccionarticulo
							.getTransaccionarticuloList()
			...
			for (Transaccionfase transaccionfaseListTransaccionfase : transaccion
					.getTransaccionfaseList()) {
				Transaccion oldIdTransaccionOfTransaccionfaseListTransaccionfase = transaccionfaseListTransaccionfase
						.getIdTransaccion();
				transaccionfaseListTransaccionfase
						.setIdTransaccion(transaccion);
				transaccionfaseListTransaccionfase = em
						.merge(transaccionfaseListTransaccionfase);
				if (oldIdTransaccionOfTransaccionfaseListTransaccionfase != null) {
					oldIdTransaccionOfTransaccionfaseListTransaccionfase
							.getTransaccionfaseList()
			...
			for (Transacciondocumento transacciondocumentoListTransacciondocumento : transaccion
				...
				if (oldIdTransaccionOfTransacciondocumentoListTransacciondocumento != null) {
					oldIdTransaccionOfTransacciondocumentoListTransacciondocumento
							.getTransacciondocumentoList()
			...
			for (Transaccioncliente transaccionclienteListTransaccioncliente : transaccion
				...
				if (oldIdTransaccionOfTransaccionclienteListTransaccioncliente != null) {
					oldIdTransaccionOfTransaccionclienteListTransaccioncliente
							.getTransaccionclienteList()
			...
			for (Pagocredito pagocreditoListPagocredito : transaccion
					.getPagocreditoList()) {
				...
				if (oldIdTransaccionOfPagocreditoListPagocredito != null) {
					oldIdTransaccionOfPagocreditoListPagocredito
							.getPagocreditoList()
							.remove(pagocreditoListPagocredito);
					oldIdTransaccionOfPagocreditoListPagocredito = em.merge(
							oldIdTransaccionOfPagocreditoListPagocredito);
				}
			}
			...
			if (findTransaccion(transaccion.getId()) != null) {
				throw new PreexistingEntityException(
						"Transaccion " + transaccion + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Transaccion transaccion) throws IllegalOrphanException,
			NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Transaccion persistentTransaccion = em.find(Transaccion.class,
					transaccion.getId());
			Cliente numeroIdentificacionClienteOld = persistentTransaccion
					.getNumeroIdentificacionCliente();
			Cliente numeroIdentificacionClienteNew = transaccion
					.getNumeroIdentificacionCliente();
			Usuario idUsuarioOld = persistentTransaccion.getIdUsuario();
			Usuario idUsuarioNew = transaccion.getIdUsuario();
			Rolloauditoria idRolloauditoriaOld = persistentTransaccion
					.getIdRolloauditoria();
			Rolloauditoria idRolloauditoriaNew = transaccion
					.getIdRolloauditoria();
			Serialimpresora idSerialimpresoraOld = persistentTransaccion
					.getIdSerialimpresora();
			Serialimpresora idSerialimpresoraNew = transaccion
					.getIdSerialimpresora();
			Sesion idSesionOld = persistentTransaccion.getIdSesion();
			Sesion idSesionNew = transaccion.getIdSesion();
			Transaccion idAnulaciontransaccionOld = persistentTransaccion
					.getIdAnulaciontransaccion();
			Transaccion idAnulaciontransaccionNew = transaccion
					.getIdAnulaciontransaccion();
			List<Transaccionformadepago> transaccionformadepagoListOld = persistentTransaccion
					.getTransaccionformadepagoList();
			List<Transaccionformadepago> transaccionformadepagoListNew = transaccion
					.getTransaccionformadepagoList();
			List<Transaccion> transaccionListOld = persistentTransaccion
					.getTransaccionList();
			List<Transaccion> transaccionListNew = transaccion
					.getTransaccionList();
			List<Transaccionarticulo> transaccionarticuloListOld = persistentTransaccion
					.getTransaccionarticuloList();
			List<Transaccionarticulo> transaccionarticuloListNew = transaccion
					.getTransaccionarticuloList();
			List<Transaccionfase> transaccionfaseListOld = persistentTransaccion
					.getTransaccionfaseList();
			List<Transaccionfase> transaccionfaseListNew = transaccion
					.getTransaccionfaseList();
			List<Transacciondocumento> transacciondocumentoListOld = persistentTransaccion
					.getTransacciondocumentoList();
			List<Transacciondocumento> transacciondocumentoListNew = transaccion
					.getTransacciondocumentoList();
			List<Transaccioncliente> transaccionclienteListOld = persistentTransaccion
					.getTransaccionclienteList();
			List<Transaccioncliente> transaccionclienteListNew = transaccion
					.getTransaccionclienteList();
			// List<Devolucion> devolucionListOld = persistentTransaccion
			// .getDevolucionList();
			// List<Devolucion> devolucionListNew = transaccion
			// .getDevolucionList();
			List<Pagocredito> pagocreditoListOld = persistentTransaccion
					.getPagocreditoList();
			List<Pagocredito> pagocreditoListNew = transaccion
					.getPagocreditoList();
			List<String> illegalOrphanMessages = null;
			for (Transaccionformadepago transaccionformadepagoListOldTransaccionformadepago : transaccionformadepagoListOld) {
				if (!transaccionformadepagoListNew.contains(
			...
			for (Transaccionarticulo transaccionarticuloListOldTransaccionarticulo : transaccionarticuloListOld) {
				if (!transaccionarticuloListNew.contains(
			...
			for (Transaccionfase transaccionfaseListOldTransaccionfase : transaccionfaseListOld) {
				if (!transaccionfaseListNew
						.contains(transaccionfaseListOldTransaccionfase)) {
					if (illegalOrphanMessages == null) {
						illegalOrphanMessages = new ArrayList<String>();
					}
					illegalOrphanMessages.add("You must retain Transaccionfase "
							+ transaccionfaseListOldTransaccionfase
							+ " since its idTransaccion field is not nullable.");
				}
			}
			for (Transacciondocumento transacciondocumentoListOldTransacciondocumento : transacciondocumentoListOld) {
				if (!transacciondocumentoListNew.contains(
			...
			for (Transaccioncliente transaccionclienteListOldTransaccioncliente : transaccionclienteListOld) {
				if (!transaccionclienteListNew.contains(
			...
			for (Pagocredito pagocreditoListOldPagocredito : pagocreditoListOld) {
				if (!pagocreditoListNew
						.contains(pagocreditoListOldPagocredito)) {
					if (illegalOrphanMessages == null) {
						illegalOrphanMessages = new ArrayList<String>();
					}
					illegalOrphanMessages.add("You must retain Pagocredito "
			...
			if (idRolloauditoriaNew != null) {
				idRolloauditoriaNew = em.getReference(
						idRolloauditoriaNew.getClass(),
						idRolloauditoriaNew.getId());
			...
			if (idAnulaciontransaccionNew != null) {
				idAnulaciontransaccionNew = em.getReference(
						idAnulaciontransaccionNew.getClass(),
						idAnulaciontransaccionNew.getId());
				transaccion
						.setIdAnulaciontransaccion(idAnulaciontransaccionNew);
			}
			...
			for (Transaccionformadepago transaccionformadepagoListNewTransaccionformadepagoToAttach : transaccionformadepagoListNew) {
				transaccionformadepagoListNewTransaccionformadepagoToAttach = em
						.getReference(
								...
								transaccionformadepagoListNewTransaccionformadepagoToAttach
										.getId());
				attachedTransaccionformadepagoListNew.add(
						transaccionformadepagoListNewTransaccionformadepagoToAttach);
			}
			transaccionformadepagoListNew = attachedTransaccionformadepagoListNew;
			transaccion.setTransaccionformadepagoList(
					transaccionformadepagoListNew);
			...
			for (Transaccionarticulo transaccionarticuloListNewTransaccionarticuloToAttach : transaccionarticuloListNew) {
				transaccionarticuloListNewTransaccionarticuloToAttach = em
						.getReference(
								...
								transaccionarticuloListNewTransaccionarticuloToAttach
										.getId());
				attachedTransaccionarticuloListNew.add(
						transaccionarticuloListNewTransaccionarticuloToAttach);
			}
			...
			for (Transaccionfase transaccionfaseListNewTransaccionfaseToAttach : transaccionfaseListNew) {
				transaccionfaseListNewTransaccionfaseToAttach = em.getReference(
						transaccionfaseListNewTransaccionfaseToAttach
								.getClass(),
						transaccionfaseListNewTransaccionfaseToAttach.getId());
				attachedTransaccionfaseListNew
						.add(transaccionfaseListNewTransaccionfaseToAttach);
			}
			...
			for (Transacciondocumento transacciondocumentoListNewTransacciondocumentoToAttach : transacciondocumentoListNew) {
				transacciondocumentoListNewTransacciondocumentoToAttach = em
						.getReference(
								...
								transacciondocumentoListNewTransacciondocumentoToAttach
										.getId());
				attachedTransacciondocumentoListNew.add(
						transacciondocumentoListNewTransacciondocumentoToAttach);
			}
			...
			for (Transaccioncliente transaccionclienteListNewTransaccionclienteToAttach : transaccionclienteListNew) {
				transaccionclienteListNewTransaccionclienteToAttach = em
						.getReference(
								...
								transaccionclienteListNewTransaccionclienteToAttach
										.getId());
				attachedTransaccionclienteListNew.add(
						transaccionclienteListNewTransaccionclienteToAttach);
			}
			...
			// for (Devolucion devolucionListNewDevolucionToAttach :
			// devolucionListNew) {
			// devolucionListNewDevolucionToAttach = em.getReference(
			// devolucionListNewDevolucionToAttach.getClass(),
			// devolucionListNewDevolucionToAttach.getId());
			// attachedDevolucionListNew
			// .add(devolucionListNewDevolucionToAttach);
			// }
			...
			if (numeroIdentificacionClienteOld != null
				...
				numeroIdentificacionClienteOld.getTransaccionList()
						.remove(transaccion);
			...
			if (numeroIdentificacionClienteNew != null
				...
				numeroIdentificacionClienteNew.getTransaccionList()
						.add(transaccion);
			...
			if (idRolloauditoriaOld != null
					&& !idRolloauditoriaOld.equals(idRolloauditoriaNew)) {
				idRolloauditoriaOld.getTransaccionList().remove(transaccion);
				idRolloauditoriaOld = em.merge(idRolloauditoriaOld);
			}
			if (idRolloauditoriaNew != null
					&& !idRolloauditoriaNew.equals(idRolloauditoriaOld)) {
			...
			if (idAnulaciontransaccionOld != null && !idAnulaciontransaccionOld
					.equals(idAnulaciontransaccionNew)) {
				idAnulaciontransaccionOld.getTransaccionList()
						.remove(transaccion);
				idAnulaciontransaccionOld = em.merge(idAnulaciontransaccionOld);
			}
			if (idAnulaciontransaccionNew != null && !idAnulaciontransaccionNew
					.equals(idAnulaciontransaccionOld)) {
			...
			for (Transaccionformadepago transaccionformadepagoListNewTransaccionformadepago : transaccionformadepagoListNew) {
				if (!transaccionformadepagoListOld.contains(
			...
			for (Transaccion transaccionListOldTransaccion : transaccionListOld) {
				if (!transaccionListNew
						.contains(transaccionListOldTransaccion)) {
					transaccionListOldTransaccion
							.setIdAnulaciontransaccion(null);
			...
			for (Transaccion transaccionListNewTransaccion : transaccionListNew) {
				if (!transaccionListOld
						.contains(transaccionListNewTransaccion)) {
					...
					if (oldIdAnulaciontransaccionOfTransaccionListNewTransaccion != null
							&& !oldIdAnulaciontransaccionOfTransaccionListNewTransaccion
									.equals(transaccion)) {
						oldIdAnulaciontransaccionOfTransaccionListNewTransaccion
								.getTransaccionList()
			...
			for (Transaccionarticulo transaccionarticuloListNewTransaccionarticulo : transaccionarticuloListNew) {
				if (!transaccionarticuloListOld.contains(
					...
					transaccionarticuloListNewTransaccionarticulo
							.setIdTransaccion(transaccion);
					transaccionarticuloListNewTransaccionarticulo = em.merge(
							transaccionarticuloListNewTransaccionarticulo);
					if (oldIdTransaccionOfTransaccionarticuloListNewTransaccionarticulo != null
							&& !oldIdTransaccionOfTransaccionarticuloListNewTransaccionarticulo
									.equals(transaccion)) {
						oldIdTransaccionOfTransaccionarticuloListNewTransaccionarticulo
								.getTransaccionarticuloList()
			...
			for (Transaccionfase transaccionfaseListNewTransaccionfase : transaccionfaseListNew) {
				if (!transaccionfaseListOld
						.contains(transaccionfaseListNewTransaccionfase)) {
					Transaccion oldIdTransaccionOfTransaccionfaseListNewTransaccionfase = transaccionfaseListNewTransaccionfase
							.getIdTransaccion();
					transaccionfaseListNewTransaccionfase
							.setIdTransaccion(transaccion);
					transaccionfaseListNewTransaccionfase = em
							.merge(transaccionfaseListNewTransaccionfase);
					if (oldIdTransaccionOfTransaccionfaseListNewTransaccionfase != null
							&& !oldIdTransaccionOfTransaccionfaseListNewTransaccionfase
									.equals(transaccion)) {
						oldIdTransaccionOfTransaccionfaseListNewTransaccionfase
								.getTransaccionfaseList()
			...
			for (Transacciondocumento transacciondocumentoListNewTransacciondocumento : transacciondocumentoListNew) {
				if (!transacciondocumentoListOld.contains(
					...
					transacciondocumentoListNewTransacciondocumento
							.setIdTransaccion(transaccion);
					transacciondocumentoListNewTransacciondocumento = em.merge(
							transacciondocumentoListNewTransacciondocumento);
					if (oldIdTransaccionOfTransacciondocumentoListNewTransacciondocumento != null
							&& !oldIdTransaccionOfTransacciondocumentoListNewTransacciondocumento
									.equals(transaccion)) {
						oldIdTransaccionOfTransacciondocumentoListNewTransacciondocumento
								.getTransacciondocumentoList()
			...
			for (Transaccioncliente transaccionclienteListNewTransaccioncliente : transaccionclienteListNew) {
				if (!transaccionclienteListOld.contains(
					...
					if (oldIdTransaccionOfTransaccionclienteListNewTransaccioncliente != null
							&& !oldIdTransaccionOfTransaccionclienteListNewTransaccioncliente
									.equals(transaccion)) {
						oldIdTransaccionOfTransaccionclienteListNewTransaccioncliente
								.getTransaccionclienteList()
			...
			for (Pagocredito pagocreditoListNewPagocredito : pagocreditoListNew) {
				if (!pagocreditoListOld
						.contains(pagocreditoListNewPagocredito)) {
					...
					if (oldIdTransaccionOfPagocreditoListNewPagocredito != null
							&& !oldIdTransaccionOfPagocreditoListNewPagocredito
									.equals(transaccion)) {
						oldIdTransaccionOfPagocreditoListNewPagocredito
								.getPagocreditoList()
	...
	public void destroy(Long id)
		...
		try {
			...
			try {
				...
				throw new NonexistentEntityException(
						"The transaccion with id " + id + " no longer exists.",
						enfe);
			}
			List<String> illegalOrphanMessages = null;
			...
			List<Transaccionarticulo> transaccionarticuloListOrphanCheck = transaccion
					.getTransaccionarticuloList();
			...
			List<Transaccionfase> transaccionfaseListOrphanCheck = transaccion
					.getTransaccionfaseList();
			for (Transaccionfase transaccionfaseListOrphanCheckTransaccionfase : transaccionfaseListOrphanCheck) {
				...
				illegalOrphanMessages.add("This Transaccion (" + transaccion
						+ ") cannot be destroyed since the Transaccionfase "
						+ transaccionfaseListOrphanCheckTransaccionfase
						+ " in its transaccionfaseList field has a non-nullable idTransaccion field.");
			}
			List<Transacciondocumento> transacciondocumentoListOrphanCheck = transaccion
					.getTransacciondocumentoList();
			...
			List<Transaccioncliente> transaccionclienteListOrphanCheck = transaccion
					.getTransaccionclienteList();
			...
			// List<Devolucion> devolucionListOrphanCheck = transaccion
			// .getDevolucionList();
			...
			// + " in its devolucionList field has a non-nullable idTransaccion
			// field.");
			// }
			List<Pagocredito> pagocreditoListOrphanCheck = transaccion
					.getPagocreditoList();
			...
			List<Transaccion> transaccionList = transaccion
					.getTransaccionList();
	 ...
	 * @return List<Transaccion>
	 */
	public List<Transaccion> findTransaccionEntities(int maxResults,
			int firstResult) {
	 ...
	 * @return List<Transaccion>
	 */
	private List<Transaccion> findTransaccionEntities(boolean all,
