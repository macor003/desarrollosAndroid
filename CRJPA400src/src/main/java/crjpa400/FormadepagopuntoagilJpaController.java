...
public class FormadepagopuntoagilJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Formadepagopuntoagil formadepagopuntoagil)
			throws PreexistingEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Transaccionformadepago idTransaccionformadepago = formadepagopuntoagil
					.getIdTransaccionformadepago();
			if (idTransaccionformadepago != null) {
				idTransaccionformadepago = em.getReference(
						idTransaccionformadepago.getClass(),
						idTransaccionformadepago.getId());
				formadepagopuntoagil
						.setIdTransaccionformadepago(idTransaccionformadepago);
			}
			em.persist(formadepagopuntoagil);
			if (idTransaccionformadepago != null) {
				idTransaccionformadepago.getFormadepagopuntoagilList().add(
						formadepagopuntoagil);
			...
			if (findFormadepagopuntoagil(formadepagopuntoagil.getId()) != null) {
				throw new PreexistingEntityException("Formadepagopuntoagil "
						+ formadepagopuntoagil + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Formadepagopuntoagil formadepagopuntoagil)
			throws NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Formadepagopuntoagil persistentFormadepagopuntoagil = em.find(
					Formadepagopuntoagil.class, formadepagopuntoagil.getId());
			Transaccionformadepago idTransaccionformadepagoOld = persistentFormadepagopuntoagil
					.getIdTransaccionformadepago();
			Transaccionformadepago idTransaccionformadepagoNew = formadepagopuntoagil
					.getIdTransaccionformadepago();
			if (idTransaccionformadepagoNew != null) {
				idTransaccionformadepagoNew = em.getReference(
						idTransaccionformadepagoNew.getClass(),
						idTransaccionformadepagoNew.getId());
				formadepagopuntoagil
						.setIdTransaccionformadepago(idTransaccionformadepagoNew);
			}
			formadepagopuntoagil = em.merge(formadepagopuntoagil);
			if (idTransaccionformadepagoOld != null
					&& !idTransaccionformadepagoOld
							.equals(idTransaccionformadepagoNew)) {
				idTransaccionformadepagoOld.getFormadepagopuntoagilList()
						.remove(formadepagopuntoagil);
				idTransaccionformadepagoOld = em
						.merge(idTransaccionformadepagoOld);
			}
			if (idTransaccionformadepagoNew != null
					&& !idTransaccionformadepagoNew
							.equals(idTransaccionformadepagoOld)) {
				idTransaccionformadepagoNew.getFormadepagopuntoagilList().add(
						formadepagopuntoagil);
				idTransaccionformadepagoNew = em
						.merge(idTransaccionformadepagoNew);
			}
			em.getTransaction().commit();
		} catch (Exception ex) {
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findFormadepagopuntoagil(id) == null) {
					throw new NonexistentEntityException(
							"The formadepagopuntoagil with id " + id
									+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws NonexistentEntityException {
		...
		try {
			...
			try {
				formadepagopuntoagil = em.getReference(
						Formadepagopuntoagil.class, id);
			...
			Transaccionformadepago idTransaccionformadepago = formadepagopuntoagil
					.getIdTransaccionformadepago();
			if (idTransaccionformadepago != null) {
				idTransaccionformadepago.getFormadepagopuntoagilList().remove(
						formadepagopuntoagil);
				idTransaccionformadepago = em.merge(idTransaccionformadepago);
			}
	 ...
	 * @return List<Formadepagopuntoagil>
	 */
	private List<Formadepagopuntoagil> findFormadepagopuntoagilEntities(
