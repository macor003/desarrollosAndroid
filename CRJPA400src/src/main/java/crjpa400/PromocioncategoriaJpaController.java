...
public class PromocioncategoriaJpaController implements Serializable {
	 ...
	 * @throws Exception
	 */
	public void create(Promocioncategoria promocioncategoria)
		...
		try {
			...
			if (findPromocioncategoria(promocioncategoria.getId()) != null) {
				throw new PreexistingEntityException("Promocioncategoria "
						+ promocioncategoria + " already exists.", ex);
			}
			throw ex;
		} finally {
			if (em != null) {
	 ...
	 * @throws Exception
	 */
	public void edit(Promocioncategoria promocioncategoria)
			throws NonexistentEntityException, Exception {
		EntityManager em = null;
		try {
			em = getEntityManager();
			em.getTransaction().begin();
			Promocioncategoria persistentPromocioncategoria = em.find(
					Promocioncategoria.class, promocioncategoria.getId());
			Promocion idPromocionOld = persistentPromocioncategoria
					.getIdPromocion();
			Promocion idPromocionNew = promocioncategoria.getIdPromocion();
			Categoria idCategoriaOld = persistentPromocioncategoria
					.getIdCategoria();
			...
			if (msg == null || msg.length() == 0) {
				...
				if (findPromocioncategoria(id) == null) {
					throw new NonexistentEntityException(
							"The promocioncategoria with id " + id
									+ " no longer exists.");
				}
			}
			throw ex;
	...
	public void destroy(Long id) throws NonexistentEntityException {
		...
		try {
			...
			try {
				promocioncategoria = em.getReference(Promocioncategoria.class,
						id);
			...
			Promocion idPromocion = promocioncategoria.getIdPromocion();
			if (idPromocion != null) {
				idPromocion.getPromocioncategoriaList().remove(
						promocioncategoria);
				idPromocion = em.merge(idPromocion);
			}
			Categoria idCategoria = promocioncategoria.getIdCategoria();
			if (idCategoria != null) {
				idCategoria.getPromocioncategoriaList().remove(
						promocioncategoria);
				idCategoria = em.merge(idCategoria);
			}
	 ...
	 * @return List<Promocioncategoria>
	 */
	private List<Promocioncategoria> findPromocioncategoriaEntities(
