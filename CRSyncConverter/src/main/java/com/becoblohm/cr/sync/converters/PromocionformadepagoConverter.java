 ...
 */
public class PromocionformadepagoConverter implements ConverterInterface {

	/**
	 * 
	 */
	public PromocionformadepagoConverter() {
	...
	public Object fromServer(Object obj, String posId) {
		...
		crjpa400.Promocionformadepago serverValue = (crjpa400.Promocionformadepago) obj;
		crjpa.Promocionformadepago posValue = new Promocionformadepago();
		...
		crjpa.Formadepago tmp = new crjpa.Formadepago(serverValue.getIdFormadepago().getId());
		...
		dm.setTableName(crjpa.Promocionformadepago.class.getName().substring(
				crjpa.Promocionformadepago.class.getName().lastIndexOf(".") + 1));
		return dm;
	}
